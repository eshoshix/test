...
namespace test_DataBase {
    ...
    public partial class database1DataSet : global::System.Data.DataSet {
        ...
        public partial class ВрачDataTable : global::System.Data.TypedTableBase<ВрачRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ВрачRow AddВрачRow(string ФИО, string Специальность) {
        ...
        public partial class ВрачRow : global::System.Data.DataRow {
            ...
            public string ФИО {
                get {
                    return ((string)(this[this.tableВрач.ФИОColumn]));
                }
                set {
                    this[this.tableВрач.ФИОColumn] = value;
                }
            }
...
namespace test_DataBase.database1DataSetTableAdapters {
    ...
    public partial class ВрачTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Врач] WHERE (([ID врача] = @Original_ID_врача) AND ([ФИО] = @O" +
                "riginal_ФИО) AND ([Специальность] = @Original_Специальность))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Врач] SET [ФИО] = @ФИО, [Специальность] = @Специальность WHERE (([ID врача] = @Original_ID_врача) AND ([ФИО] = @Original_ФИО) AND ([Специальность] = @Original_Специальность));
SELECT [ID врача], ФИО, Специальность FROM Врач WHERE ([ID врача] = @ID_врача)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::test_DataBase.Properties.Settings.Default.database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT [ID врача], ФИО, Специальность FROM dbo.Врач";
        ...
        public virtual int Fill(database1DataSet.ВрачDataTable dataTable) {
        ...
        public virtual database1DataSet.ВрачDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            database1DataSet.ВрачDataTable dataTable = new database1DataSet.ВрачDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(database1DataSet.ВрачDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID_врача, string Original_ФИО, string Original_Специальность) {
        ...
        public virtual int Update(string ФИО, string Специальность, int Original_ID_врача, string Original_ФИО, string Original_Специальность, int ID_врача) {
            if ((ФИО == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[2].Value = ((int)(Original_ID_врача));
            if ((Original_ФИО == null)) {
                throw new global::System.ArgumentNullException("Original_ФИО");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(ID_врача));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ФИО, string Специальность, int Original_ID_врача, string Original_ФИО, string Original_Специальность) {
            return this.Update(ФИО, Специальность, Original_ID_врача, Original_ФИО, Original_Специальность, Original_ID_врача);
        }
    }
